...
const HeroSpeedSection = () => {
  ...
  // Fashion item icons
  const fashionIcons = [
    { Icon: Shirt, color: "text-purple-600" },
    { Icon: Package, color: "text-pink-600" },
    { Icon: Star, color: "text-blue-600" },
    { Icon: Sparkles, color: "text-indigo-600" },
    { Icon: Shirt, color: "text-violet-600" },
    { Icon: Package, color: "text-purple-600" },
  ];
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="absolute inset-0 p-8">
                ...
                {/* Fashion Items Grid - Larger */}
                <div className="grid grid-cols-3 gap-4 mb-6">
                  {fashionIcons.map((item, i) => (
                    <motion.div
                      key={i}
                      className="aspect-square bg-gradient-to-br from-purple-100/60 to-pink-100/60 rounded-xl border border-purple-200/30 flex items-center justify-center relative overflow-hidden"
                      animate={{
                        scale: [1, 1.02, 1],
                        opacity: [0.8, 1, 0.8],
                      }}
                    ...
                    >
                      <item.Icon
                        className={`w-8 h-8 ${item.color} opacity-70`}
                        strokeWidth={1.5}
                      />
                      {/* Processing effect */}
                      {i < 3 && (
        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-8 py-4 bg-gradient-to-r from-purple-600 via-violet-600 to-purple-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 relative overflow-hidden group"
            >
              <motion.div
