    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center relative z-10">
            ...
            >
              <div className="relative">
                ...
                >
                  <div className="relative w-96 h-[500px] bg-white/15 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <img
                      src="/Images/13.jpeg" // Replace with your detailed closeup image
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 bg-white/50 border border-gray-200/40 rounded-full backdrop-blur-sm"
              >
              ...
              >
                {[
                  { icon: Zap, label: "60% Faster", value: "Processing Speed" },
                  { icon: Star, label: "99% Quality", value: "Maintained" },
                  { icon: Palette, label: "500+ Brands", value: "Trust Us" },
                ].map((stat, i) => (
                  <div key={i} className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-purple-100/60 to-pink-100/60 rounded-xl flex items-center justify-center border border-purple-200/30 backdrop-blur-sm">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-4 bg-white/50 backdrop-blur-sm border border-gray-200/50 text-gray-700 font-semibold rounded-xl hover:bg-white/70 transition-all duration-300 flex items-center gap-3 group"
                >
          ...
          {/* Enhanced Bottom Trust Strip - Simple */}
          <motion.div
            initial={{ opacity: 0, y: 15 }}
          ...
          >
            <div className="flex items-center justify-center space-x-6">
              ...
              <motion.button
                ...
                className="text-purple-600 hover:text-purple-700 transition-colors flex items-center space-x-2 font-medium ml-4"
              >
